...
import { Badge, Heart, ShoppingBasket } from "lucide-react";

import { DeleteProductButton } from "@/components/gender/delete-product-button";
import { LikeButton } from "@/components/gender/like-button";
...
function ShoppingBagItem({ product }: ShoppingBagItemProps) {
  ...
  return (
    <div className="flex space-x-5">
      <SheetClose asChild>
        <Link to={href} key={product.cartProductId}>
          <img
            ...
            {shoppingBagItems.length > 0 ? (
              <div className="h-full flex flex-col">
                ...
                <div>
                  ...
                  >
                    <SheetClose asChild>
                      <Link to="/cart">Process order</Link>
                    </SheetClose>
                  </Button>
                </div>
              </div>
